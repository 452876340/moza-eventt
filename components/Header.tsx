...
const Header: React.FC<HeaderProps> = ({ title = "株洲速度节", seriesId = 'zhuzhou' }) => {
  ...
  return (
    <div className="w-full @container">
      <div className="relative min-h-[520px] w-full flex flex-col items-center justify-center overflow-hidden">
        <div 
        ...
        />
        <div className="relative z-10 w-full max-w-[1200px] px-6 pt-12 pb-16 flex flex-col gap-10">
          <div className="flex flex-col gap-4 text-center md:text-left">
            <div className="inline-flex self-center md:self-start items-center gap-2 bg-primary/20 backdrop-blur-md border border-primary/40 text-primary px-4 py-1.5 rounded-full">
              <span className="relative flex h-2.5 w-2.5">
                <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-primary opacity-75"></span>
                <span className="relative inline-flex rounded-full h-2.5 w-2.5 bg-primary"></span>
              </span>
              <span className="text-[10px] font-black uppercase tracking-[0.2em]">株洲国际赛车场现场直播</span>
            </div>
