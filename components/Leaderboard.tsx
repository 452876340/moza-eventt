            ...
            <tbody className="divide-y divide-[#e6e1db] dark:divide-[#2d261f]">
              {isLoading ? (
                ...
                <tr key={driver.id} className="hover:bg-[#fcfbf9] dark:hover:bg-[#231d16] transition-colors group">
                  ...
                  <td className="sticky left-0 z-10 bg-white dark:bg-[#1a1612] group-hover:bg-[#fcfbf9] dark:group-hover:bg-[#231d16] px-1 py-1 md:px-4 md:py-1.5 font-bold text-xs md:text-lg group-hover:text-primary transition-colors shadow-[2px_0_5px_-2px_rgba(0,0,0,0.1)] whitespace-nowrap">
                    {driver.name}
                  </td>
